...
export const soundThemes: Record<SoundTheme, ThemeConfig> = {
  classic: {
    ...
    sounds: {
      success: { frequency: 1200, type: 'sine', duration: 0.15, gain: 0.6 },
      error: { frequency: 300, frequency2: 200, type: 'square', duration: 0.4, gain: 0.5 },
      warning: { frequency: 800, type: 'triangle', duration: 0.2, gain: 0.5 },
      click: { frequency: 1800, type: 'sine', duration: 0.05, gain: 0.4 },
      location: [
        { frequency: 1000, type: 'sine', duration: 0.1, gain: 0.5 },
        { frequency: 1400, type: 'sine', duration: 0.1, gain: 0.5 },
      ],
      container: [
        { frequency: 880, type: 'sine', duration: 0.12, gain: 0.5 },
        { frequency: 1100, type: 'sine', duration: 0.18, gain: 0.5 },
      ],
    },
  },
  ...
  material: {
    ...
    sounds: {
      success: { frequency: 880, frequency2: 1320, type: 'sine', duration: 0.2, gain: 0.5, ramp: 0.1 },
      error: { frequency: 220, frequency2: 165, type: 'triangle', duration: 0.5, gain: 0.5 },
      warning: { frequency: 587, type: 'sine', duration: 0.25, gain: 0.5 },
      click: { frequency: 1500, type: 'sine', duration: 0.05, gain: 0.35 },
      location: [
        { frequency: 523, type: 'sine', duration: 0.12, gain: 0.5 },
        { frequency: 784, type: 'sine', duration: 0.18, gain: 0.5 },
      ],
      container: [
        { frequency: 659, type: 'sine', duration: 0.12, gain: 0.5 },
        { frequency: 988, type: 'sine', duration: 0.18, gain: 0.5 },
      ],
    },
  },
  ...
  ios: {
    ...
    sounds: {
      success: { frequency: 1567, type: 'sine', duration: 0.12, gain: 0.5 },
      error: { frequency: 262, frequency2: 196, type: 'sine', duration: 0.4, gain: 0.5 },
      warning: { frequency: 1047, type: 'sine', duration: 0.15, gain: 0.5 },
      click: { frequency: 1400, type: 'sine', duration: 0.04, gain: 0.3 },
      location: [
        { frequency: 1319, type: 'sine', duration: 0.08, gain: 0.5 },
        { frequency: 1568, type: 'sine', duration: 0.12, gain: 0.5 },
      ],
      container: [
        { frequency: 1047, type: 'sine', duration: 0.1, gain: 0.5 },
        { frequency: 1397, type: 'sine', duration: 0.15, gain: 0.5 },
      ],
    },
  },
  ...
  retro: {
    ...
    sounds: {
      success: { frequency: 660, frequency2: 880, type: 'square', duration: 0.15, gain: 0.4 },
      error: { frequency: 150, frequency2: 100, type: 'square', duration: 0.5, gain: 0.4 },
      warning: { frequency: 440, type: 'square', duration: 0.2, gain: 0.35 },
      click: { frequency: 1200, type: 'square', duration: 0.04, gain: 0.25 },
      location: [
        { frequency: 523, type: 'square', duration: 0.1, gain: 0.35 },
        { frequency: 698, type: 'square', duration: 0.1, gain: 0.35 },
        { frequency: 880, type: 'square', duration: 0.12, gain: 0.35 },
      ],
      container: [
        { frequency: 440, type: 'square', duration: 0.1, gain: 0.35 },
        { frequency: 587, type: 'square', duration: 0.1, gain: 0.35 },
        { frequency: 740, type: 'square', duration: 0.12, gain: 0.35 },
      ],
    },
  },
  ...
  minimal: {
    ...
    sounds: {
      success: { frequency: 1400, type: 'sine', duration: 0.08, gain: 0.4 },
      error: { frequency: 400, type: 'sine', duration: 0.3, gain: 0.4 },
      warning: { frequency: 900, type: 'sine', duration: 0.12, gain: 0.35 },
      click: { frequency: 1600, type: 'sine', duration: 0.03, gain: 0.25 },
      location: [
        { frequency: 1200, type: 'sine', duration: 0.06, gain: 0.35 },
        { frequency: 1500, type: 'sine', duration: 0.08, gain: 0.35 },
      ],
      container: [
        { frequency: 1000, type: 'sine', duration: 0.07, gain: 0.35 },
        { frequency: 1300, type: 'sine', duration: 0.1, gain: 0.35 },
      ],
    },
  },
